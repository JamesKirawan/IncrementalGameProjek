...
public class GameManager : MonoBehaviour
{
    ...
    // Fungsi [Range(min,max)] ialah menjaga value agar tetap berada diantara min
    // dan maxnya
    [Range(0f, 1f)]
    ...
    public void AddGold(double value)
    {
        ...
        AchievementController.Instance.UnlockAchievement1(AchievementController.AchievementType.UnlockGoal, _totalGold);
    }
